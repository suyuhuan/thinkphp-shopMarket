...
-- ----------------------------
 DROP TABLE IF EXISTS `nm_auth_rule`;
CREATE TABLE `nm_auth_rule` (  
...
-- ----------------------------
 DROP TABLE IF EXISTS `nm_auth_group`;
CREATE TABLE `nm_auth_group` ( 
    `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT, 
...
-- ----------------------------
DROP TABLE IF EXISTS `nm_auth_group_access`;
CREATE TABLE `nm_auth_group_access` (  
