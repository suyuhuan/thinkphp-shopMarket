  ...
  <body>  
   ...
   <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="panel-body">
          ...
          <div class="col-md-6">
                  <form action="/2sjy/admin.php/Goods/editGoods.html?id=<?php echo ($goods["id"]); ?>" enctype="multipart/form-data" method="post" class="templatemo-login-form">
                     <div class="form-group">
                      <img src="/2sjy/Public<?php echo ($goods["good_imgs"]); ?>" style="width:100px;height:100px">
                      <label for="name">商品图片</label>
                      <input type="file" name="good_imgs" id="name">
                    </div> 
                    <div class="form-group">
                      <label for="name">商品名</label>
                      <input type="text" class="form-control" name="title" value="<?php echo ($goods["title"]); ?>" id="name">
                    </div>
                     <div class="form-group">
                      <label for="name">商品价格</label>
                      <input type="text" class="form-control" name="price" value="<?php echo ($goods["price"]); ?>" id="name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="detail" value="<?php echo ($goods["detail"]); ?>" id="name">
                    </div>  
                     <div class="form-group">
                      <label for="name">交货地点</label>
                      <input type="text" class="form-control" name="place" value="<?php echo ($goods["place"]); ?>" id="name">
                    </div>   
                        
                    <div class="form-group">
                      <button type="submit" name="sub" value="true" class="templatemo-blue-button">编辑</button>
                    </div>
                  </form>
          </div> 
        </div>   
