            ...
            <div class="col-md-1"></div>   
              ...
              <!-- 查看用户 -->
               <table class="table table-striped table-bordered templatemo-user-table">
                ...
                <tbody>
				 <?php if(is_array($user)): foreach($user as $key=>$vol): ?><tr>
                    <td><?php echo ($vol["id"]); ?></td>
                    <td><?php echo ($vol["nickname"]); ?></td>
                    <td><?php echo ($vol["email"]); ?></td>
                    <td><?php echo ($vol["phone"]); ?></td>
                    <td><?php echo ($vol["school"]); ?></td>
                    <td><?php if($vol["certification"] == 0): ?>否<?php else: ?>是<?php endif; ?></td>
                    <td>
                      <a href="/2sjy/admin.php/Users/del?id=<?php echo ($vol["id"]); ?>" class="templatemo-link">删除</a>|
                      <a href="/2sjy/admin.php/Users/edit?id=<?php echo ($vol["id"]); ?>" class="templatemo-link">编辑</a>|
                      <a href="" class="templatemo-link">认证</a>
                    </td>
