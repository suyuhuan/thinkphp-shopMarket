          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-6 col-md-6">
              <ul class="text-uppercase">
               <li><a href="/2sjy/admin.php/Users/index.html" class="active">查看</a></li>
                <li><a href="/2sjy/admin.php/Users/add.html" >添加用户</a></li>
              </ul>  
            </nav> 
          </div>
        </div>
        <div class="panel-body">
          ...
          <div class="container">
            <div class="col-md-1"></div>   
              <div class="col-md-4">
              <!-- 添加用户 -->
                  <form action="/2sjy/admin.php/Users/edit.html?id=<?php echo ($info["id"]); ?>" method="post" class="templatemo-login-form">             
                      <label for="name"></label>
                      <label for="name">昵称</label>
                      <input type="text" class="form-control" name="nickname" id="name" value="<?php echo ($info["nickname"]); ?>">
          					  <label for="name"></label>
          					  <label for="name">邮箱</label>
                      <input type="text" class="form-control" name="email" id="name" value="<?php echo ($info["email"]); ?>">
                      <label for="pass"></label>
                      <label for="pass">电话</label>
					  <input type="text" class="form-control" name="phone" id="name" value="<?php echo ($info["phone"]); ?>">
                     <label for="pass"></label>
                     <label for="pass">院校</label>
                    ...
                    <div class="form-group">
                      <button type="submit" name="sub" value="true" class="templatemo-blue-button">修改</button>
                    </div>
                  </form>
            </div>
