...
<html lang="en">
  ...
  <body>  
    ...
    <ul>
      ...
      <li><a href="/2sjy/admin.php/Links/Index.html" class="active"><i class="fa fa-map-marker fa-fw"></i>认证管理</a></li>
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-6 col-md-6">
              <ul class="text-uppercase">
                <li><a href="/2sjy/admin.php/Ce/index.html">审核认证</a></li>
                <li><a href="/2sjy/admin.php/Ce/all.html" class="active">查看所有</a></li>
              </ul>  
            </nav> 
          </div>
        </div>
