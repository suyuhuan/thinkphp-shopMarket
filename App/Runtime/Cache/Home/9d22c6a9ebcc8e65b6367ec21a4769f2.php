...
<html lang="en">
	...
	<body class="light-gray-bg">
		<div class="templatemo-content-widget templatemo-login-widget white-bg">
	        ...
	        <form action="/2sjy/index.php/Index/step.html" method="post" class="templatemo-login-form">
	        	...
	        	<div class="form-group">
	        		<div class="input-group">
		        		<div class="input-group-addon"><i class="fa fa-key fa-fw"></i>确认密码：</div>	        		
				...
				<div class="form-group">
					<button type="submit" name="sub" value="true" class="templatemo-blue-button width-100">下一步</button>
				</div>
	        </form>
		</div>
