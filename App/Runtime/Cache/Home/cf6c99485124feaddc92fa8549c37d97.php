                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <div class="col-md-8">
                      <ul class="nav navbar-nav">
                        ...
                        <form action="/2sjy/index.php/User/message" class="navbar-form navbar-right" method="get" role="search">
...
<div class="panel panel-default" >
           <ul class="nav nav-tabs nav-justified">
              <li><a href="ziliao.html">个人资料</a></li>
               ...
               <li  class="active"><a href="message.html">消息中心</a></li>
               <li><a href="ce.html">认证信息</a></li>
            </ul>
         
            <table class="table table-striped table-bordered templatemo-user-table">
                <tbody>
                      <?php if(is_array($goodData)): foreach($goodData as $key=>$vol): ?><tr align="center">
                      <td><a href="/2sjy/index.php/Goods/goodsInfo/id/<?php echo ($vol["id"]); ?>"><img style="width:50px;height:50px;"src="/2sjy/Public/<?php echo ($vol["good_imgs"]); ?>" alt=""></a></td>
                      <td><a href=""><?php echo ($vol["title"]); ?></a></td>
